...
SELECT * FROM service join rent_type on service.rent_type_id = rent_type.rent_type_id join service_type on service.service_type_id = service_type.service_type_id;
